    ...
    firebase.firestore().doc('users/'+ currentUserModel.uid).collection('shoppingCart')
      ...
      .then(function() {
        ...
        var fadeEffect = setInterval(function () {
          if (successMsgElement.style.opacity == 0) {
            successMsgElement.style.opacity = 1.5;
          }
          if (successMsgElement.style.opacity > 0) {
            successMsgElement.style.opacity -= 0.1;
          } 
          if (successMsgElement.style.opacity == 0.1) {
            successMsgElement.style.opacity = 0;
            clearInterval(fadeEffect);
          } 
        }, 200);
        //successMsgElement.style.opacity = "1"
        disableLoader()
